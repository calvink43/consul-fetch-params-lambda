...
This is a sample template for feature_flags - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name feature_flags --tail
```
...
```bash
aws cloudformation delete-stack --stack-name feature_flags
```
